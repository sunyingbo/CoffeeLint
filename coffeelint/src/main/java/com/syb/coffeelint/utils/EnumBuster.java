...
public class EnumBuster<E extends Enum<E>> {
    ...
    /**
     * Make a new enum instance with the given value and additional parameters.
     * The additionalTypes is used to match the constructor accurately.
     */
    public E make(String value, Class[] additionalTypes, Object[] additional) {
        return make(value, 0, additionalTypes, additional);
    }
    ...
    private E constructEnum(
            Class<E> clazz, ConstructorAccessor ca, String value, int ordinal, Object[] additional)
            throws Exception {
    ...
    private void setStaticFinalField(Field field, Object value) throws NoSuchFieldException, IllegalAccessException {
        // 获得 public 权限
        field.setAccessible(true);
